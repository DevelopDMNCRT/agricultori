<template>
  <FullScreenLayout>
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      <div class="relative flex flex-col items-center justify-center w-full h-screen dark:bg-gray-900">
        <div class="w-full max-w-md">
          
          <div class="text-center mb-8">
            <img src="/logo.png" alt="AgricultoriAdmin Logo" class="w-auto h-20 mx-auto" />
          </div>
            ...
            <div class="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  id="email"
                  required
                  placeholder="ejemplo@agricultori.mx"
              ...
              <!-- Button -->
              <div>
                <button type="submit" :disabled="loading" class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600 disabled:opacity-50">
